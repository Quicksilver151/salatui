...
- [ ] TUI main display (menu/settings screens exist, main salat screen pending)
...
- `backends/`
  ...
  - `salat_com.rs` — salat.com website source (future)
- `ui.rs` — frame dispatch per screen; layout containers
  - `ui/menu.rs`, `ui/settings.rs` — implemented screens
  - `ui/calender.rs` — stub
